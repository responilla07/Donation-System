...
import 'package:donation_system/Models/PayMongoAPIModel.dart';
...
class _OrderPageState extends State<OrderPage> {
  ...
  PayMongoAPIModel payMongoAPIModel = PayMongoAPIModel({});
  int selectedRadio = 0;
            ...
            children: <Widget>[
              ...
              GestureDetector(
                onTap: (){
                  ...
                  // if (cardController.text.trim().length == 16 && monthController.text.trim().length == 2 && yearController.text.trim().length == 4 && cvcController.text.trim().length == 3 && month.contains(int.parse(monthController.text.trim()))) {
                  //   set ();
                  //   getBranchKey();
                  // } else {
                  //   Toast.show("Kindly complete the required card details above.", context, duration: 3);
                  // }
                },
                child: Container(
  ...
  selectedMethod(int val) {
    setState(() {
      selectedRadio = val;
      if (selectedRadio == 1) {
        payMongoAPIModel.paymentOption = "Cash on Delivery";
      } else if (selectedRadio == 2) {
        payMongoAPIModel.paymentOption = "card";
      } else if (selectedRadio == 3) {
        payMongoAPIModel.paymentOption = "gcash";
      } else if (selectedRadio == 4) {
        payMongoAPIModel.paymentOption = "Over The Counter";
      }
    });
  }
